...
public class YoutubeCommentsInfoItemExtractor implements CommentsInfoItemExtractor {
    ...
    /**
     * @return the exact like count
     */
    @Override
    public int getLikeCount() throws ParsingException {
        final String likeCount = Utils.removeNonDigitCharacters(JsonUtils.getString(json, "actionButtons.commentActionButtonsRenderer.likeButton.toggleButtonRenderer.accessibilityData.accessibilityData.label"));
        try {
